...
public class OSMTracker {
	...
	public static final class Preferences {
		...
		public final static String KEY_GPS_TRACKPOINT_ACCURACY_THRESHOLD = "gps.logging.trackpoint_accuracy_threshold";
		...
		public final static String VAL_GPS_TRACKPOINT_ACCURACY_THRESHOLD = "0";
